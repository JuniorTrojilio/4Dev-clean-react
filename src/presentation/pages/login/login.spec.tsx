...
const testButtonIsDisabled = (sut: RenderResult, fieldName: string, isDisable: boolean): void => {
...
describe('Login Component', () => {
  ...
  test('should enable submit button of form is valid', () => {
    const { sut } = makeSut()
    populateEmailField(sut)
    populatepasswordField(sut)
  ...
  test('should add accesToken to local storage on sucess', async () => {
    const { sut, authenticationSpy } = makeSut()
    await simulateValidSubmit(sut)
